...
export default function Cart({ carrito, setCarrito }) {
  ...
  // CORRECCIÓN: Usamos nombre_pan y precio tal cual vienen de tu base de datos
  ...
  const processPayment = async (e) => {
    ...
    try {
      ...
      setModal({ show: true, type: 'error', title: 'Error', message: 'No se pudo enviar el pedido.' });
    } finally {
      setIsLoading(false);
    }
  };
